...
public class Programmers_clothes_Disguise {
    public static void main(String[] args){
        String[][] clothes= {{"yellow_hat", "headgea"}, {"blue_sunglasses", "eyewear"}, {"green_turban", "headgear"}};
        int result;
    ...
    public static int solution(String[][] clothes) {
        HashMap<String,Integer> hm = new HashMap<String,Integer>(); // 종류, 등장횟수

        for(int i=0; i<clothes.length; i++) {  // clothes.length = 3
            if(hm.containsKey(clothes[i][1]))  // hm에 clothes[i][1] 이 이미 있는지 확인하는 거 : containsKey
